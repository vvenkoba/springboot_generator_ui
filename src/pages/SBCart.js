...
import SBProjectForm from './SBProjectForm';
import SBCDForm from './SBCDForm';
import SBReview from './SBReview';
import Folder from './Folder'
import LinearProgress, { LinearProgressProps } from '@mui/material/LinearProgress';
import SBSourceForm from './SBSourceForm';
import SBGenerate from './SBGenerate';
...
const steps = ['Generate Project', 'Project Information', 'Configurations', 'CI-CD Config', 'Review and Download'];
...
export default function SBCart() {
      ...
      <Container component="main" maxWidth="md" sx={{ mb: 6 }}>
        <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
          <Typography component="h1" variant="h4" align="center">
            SpringBoot Boilerplate Code Generator
          </Typography>
